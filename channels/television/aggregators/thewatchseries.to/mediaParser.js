...
function parseIndex(body, req, res) {
	...
	var mediaObjectHTML = $("ul.listings").find("li.category-item")
...
function parseMediaObjectHTML(mediaObjectHTML, mediaObject) {
	...
	mediaObject.images.poster = img.attr("src")

	// Example info page URL: /watch-2717625-How-the-Universe-Works-online-free
	mediaObject.info = alink.attr("href")

	// todo: get description and year for media object.
	// Thats all the information available from this provider.
	...
	*/
	...
	// Get year from title
	var title = alink.text() //alink.attr("title")
	//console.log(title)
